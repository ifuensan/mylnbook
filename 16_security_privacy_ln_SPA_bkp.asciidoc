...
//ERROR
=== Diferencias entre Lightning Network y Bitcoin en terminos de privacidad
...
//ERROR
==== Revelacion de saldos de canales (Sondeo o "Probing")
...
//ERROR
=== Cross-Layer De-Anonymization o Desanonimizacion de capas cruzadas
...
//ERROR
==== Agrupacion de entidades de Bitcoin On-chain 
...
//ERROR
==== Agrupacion Off-Chain de nodos Lightning
